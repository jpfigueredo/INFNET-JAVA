		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav ms-auto my-2 my-lg-0">
				<c:if test="${not empty user}">
					<li class="nav-item"><a class="nav-link" href="/guerreiros">Guerreiros</a></li>
					<li class="nav-item"><a class="nav-link" href="/magos">Magos</a></li>
					<li class="nav-item"><a class="nav-link" href="/arqueiros">Arqueiros</a></li>
