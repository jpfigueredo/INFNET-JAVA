...
public class Mago extends Personagem{
	...
	public Mago(int inteligencia, int sabedoria, int sorte, List<String> magias) throws SkillsInvalidasException , NumeroNegativoException , NumeroNuloException, AtributosExcedidosException{
		...
		if(inteligencia < 0 || sabedoria < 0 || sorte < 0) {throw new NumeroNegativoException("Habilidades não podem ser negativas.");}
		if(inteligencia > 10 || sabedoria > 10 || sorte > 10) {throw new AtributosExcedidosException("Atributos excedidos. Nível máximo de atributos: 10.");}
		if(inteligencia == 0 || sabedoria == 0 || sorte == 0) {throw new NumeroNuloException("Habilidades não podem ser iguais à 0.");}
		if(magias.isEmpty()) {throw new SkillsInvalidasException("Habilidades inválidas, insira uma habilidade.");}
