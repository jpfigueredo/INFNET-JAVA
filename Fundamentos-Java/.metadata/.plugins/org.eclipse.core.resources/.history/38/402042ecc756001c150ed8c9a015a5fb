...
public class Jogador {
	...
	public Jogador(String nome, String email, int idade) throws InvalidNameException, InvalidEmailException, IdadeInvalidaException {
		...
		if(nome == null || nome.length() < 0) {
			throw new InvalidNameException("Nome inválido, insira um valor.");}
		if(email == null || email.length() < 0) {
			throw new InvalidEmailException("Email inválido, insira um valor.");}
		if(idade == 0) {throw new IdadeInvalidaException("Idade inválida, insira um valor.");}
