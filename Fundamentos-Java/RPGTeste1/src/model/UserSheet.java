...
public class UserSheet {
	...
	public UserSheet(User user) throws InvalidUserException{
	...
	public void print() throws CharacterListNullException{
		...
		if(characterList == null) {throw new CharacterListNullException("Null Characters List.");}
		if(characterList.isEmpty()) {throw new CharacterListNullException("Null Characters List.");}
